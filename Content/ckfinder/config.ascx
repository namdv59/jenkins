...
<%@ Import Namespace="EInvoice.SuperAdmin" %>
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //BaseUrl = FanxiContext.Current.CurrentSite.SiteDataDirectory + "UserFiles";
        BaseUrl = string.Format("/SiteData/{0}/UserFiles", FanxiContext.Current.CurrentSite.siteid.ToString());
       // BaseUrl =  string.Format("{0}/SiteData/{1}/UserFiles", FanxiContext.Current.CurrentSite.homeurl, FanxiContext.Current.CurrentSite.siteid.ToString());
       
        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = FanxiContext.Current.PhysicalSiteDataDirectory + "UserFiles";
		...
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc","docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "zip" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Images" );
        type.Url = FanxiContext.Current.CurrentSite.homeurl + BaseUrl + "/images/";
